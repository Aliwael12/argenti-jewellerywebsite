    ...
    <div class="wrapper">
        <section class="banner">
            ...
            <div class="row55">
                ...
                $sql = "SELECT p_id, name, price, thumbnail FROM product WHERE name IN ('necklace1', 'necklace2', 'necklace3', 'necklace4', 'necklace5', 'necklace6')";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class='column55'>
                            <div class='card55'>
                                <img src='" . $row['thumbnail'] . "' alt='necklace'>
