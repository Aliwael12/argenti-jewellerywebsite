    ...
    <div class="wrapper">
        <section class="banner">
            ...
            <div class="row55">
                ...
                $sql = "SELECT p_id, name, price, thumbnail FROM product WHERE name IN ('bracelet1', 'bracelet2', 'bracelet3', 'bracelet4', 'bracelet5', 'bracelet6')";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class='column55'>
                            <div class='card55'>
                                <img src='" . $row['thumbnail'] . "' alt='bracelet'>
